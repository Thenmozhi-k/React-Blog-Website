                 ...
                 <div className='grid grid-cols-2 gap-5 lg:col-span-4 md:grid-cols-4'>
                    ...
                    <div>
                        ...
                        <ul className='mt-2 space-y-2'>
                            ...
                            <li>
                                <a href="/" className='text-gray-500 transition-colors duration-300 hover:text-orange-500 '>Broucher</a>
                            </li>
                            <li>
                  ...
                  <div className='md:max-w-md lg:col-span-2 lg:mt-0 mt-5'>
                        <p className='font-medium tracking-wide text-gray-300'>Subscrption for updates</p>
                        <form className='mt-4 flex flex-col md:flex-row ' >
                            <input type="email" name='email' id='email' className='flex-grow w-full h-12 px-4 mb-3 transition duration-200 bg-white border border-gray-300 rounded shadow-sm aspect-auto md:mr-2 focus:border-purple-400 focus:outline-none' />
                            <button className='inline-flex items-center justify-center h-12 px-6 font-medium tracking-wide text-white transition duration-200 rounded shadow-md hover:bg-orange-500 focus:outline-none border' type='submit'>Subscribe</button>
                        </form>
                        <p className='mt-4 text-sm text-gray-500'>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Nobis exercitationem, modi quos eligendi nostrum similique vel sequi dolorum placeat voluptatibus expedita quibusdam ex libero ut, iure dicta adipisci consectetur. Ducimus?</p>
                    </div>
            </div>
